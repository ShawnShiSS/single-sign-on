...
* [REST API Best Practices — Implement Design Patterns for User Management API Endpoints in Authentication Server ](https://shawn-shi.medium.com/rest-api-best-practices-implement-design-patterns-for-maintainable-web-apis-in-asp-net-core-4b9118df39a)
